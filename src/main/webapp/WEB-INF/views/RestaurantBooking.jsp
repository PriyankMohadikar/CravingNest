...
<head>
    <meta charset="UTF-8">
    <title>Booking - CravingNest</title>
...
<body>
    ...
    <jsp:include page="BookingBanner.jsp"></jsp:include>
   
     
    <!-- Filter Section -->
    <div class="container mt-5">
        <div class="filter-section">
            <h3 class="text-center mb-4">Find Restaurants for Booking</h3>
            <form method="get" action="restaurantBooking" class="mb-4">
                <div class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-12 d-flex justify-content-center mt-3">
                        ...
                        <a href="restaurantBooking" class="btn btn-dark reset">Reset Filters</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <!-- Restaurants Section -->
    <div class="container mt-5">
        <h2 class="font-weight-bold fs-1 text-center mb-4">Restaurants Available for Booking</h2>
        <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card food-card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="bookingdetails?locationId=${location.locationId}" class="view-details-btn">Booking Details</a>
                        </div>
                    </div>
                </div>
            </c:forEach>
