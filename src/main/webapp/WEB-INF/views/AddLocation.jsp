...
<body>
	...
	<div class="container mt-4">
		...
		<form action="savelocation" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
				<label class="form-label">Food Place Name</label> <input type="text"
			...
			<div class="mb-3">
				<label class="form-label">Category</label> <input type="text"
					...
					placeholder="Fast Food, Pizza, etc." required>
			</div>

			<div class="mb-3">
				<label class="form-label">Food Type</label> <input type="text"
					name="foodType" class="form-control"
					placeholder="Pizza, Burger, etc." required>
			</div>
			...
			<div class="mb-3">
				<label class="form-label">Timings</label> <input type="text"
					name="timings" class="form-control" placeholder="9 AM - 9 PM"
					required>
			</div>

			<div class="mb-3">
				<label class="form-label">Contact Number</label> <input type="text"
					name="contactNumber" class="form-control" required>
			</div>
			...
			<div class="mb-3">
				<label class="form-label">City</label> <select name="cityId"
			...
			<div class="mb-3">
				<label class="form-label">Area</label> <select name="areaId"
					class="form-control" required>
